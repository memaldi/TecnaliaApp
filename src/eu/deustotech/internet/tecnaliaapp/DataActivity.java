package eu.deustotech.internet.tecnaliaapp;
...
public class DataActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        LinkedTagWorld ltw = new LinkedTagWorld(getApplicationContext(), this, getResources().openRawResource(R.raw.config_tecnalia));
        try {
